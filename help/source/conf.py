...
project = u'TelemacTools'
copyright = u'2013, APn/Artelia'
...
latex_documents = [
  ('index', 'TelemacTools.tex', u'TelemacTools Documentation',
   u'APn/Artelia', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'TelemacTools Documentation',
     [u'APn/Artelia'], 1)
]
